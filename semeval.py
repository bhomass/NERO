...
flags.DEFINE_string("pattern_file", "./data/semeval/pattern.json", "")
...
flags.DEFINE_string("test_file", "./data/semeval/test.json", "")
flags.DEFINE_string("emb_dict", "./data/semeval/emb_dict.json", "")
